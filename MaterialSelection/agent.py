...
class MaterialsAgent:
    ...
    def process_request(self, input_text: str):
        try:
            ...
            return self.format_recommendation(top_material, ranked_with_scores[1:3], requirements)
    ...
    def handle_clarification(self, input_text: str):
        ...
        return self.format_recommendation(ranked_with_scores[0][0], ranked_with_scores[1:3], combined_reqs)

    def format_recommendation(self, best_material, alternatives, requirements):
        reasons = []
        ...
        return {
            ...
            "recommended_material": {
                "name": display_name,
                "score": round(ranked_with_scores[0][1], 1), # ADDED SCORE
    ...
    def clean_properties(self, material):
        ...
        excluded = {
            ...
            'applications', 'processes', 'alloy_node', 'code'
        }
